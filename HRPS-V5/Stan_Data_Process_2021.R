...
## currently updated through 2019 data releases where available
###########################################
...
table(y_events_2, item_events_id_2)
...
table(y_events_3, item_events_id_3)
...
table(y_events_6, item_events_id_6)
...
plot(y_events_C~item_events_id_C, log="y")
