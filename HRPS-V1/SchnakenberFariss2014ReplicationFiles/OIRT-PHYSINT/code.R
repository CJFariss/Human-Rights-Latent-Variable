...
inits.function <- function(chain){
  return(switch(chain,
         "1"=list(mu=matrix(rnorm(length(panel)*max(panel), mean = 0, sd = 1), nrow=length(panel),  ncol=max(panel)), beta=runif(4), alpha0=matrix(c(runif(4), runif(4, 1, 2)), nrow=4, ncol=2, byrow=TRUE)),
         "2"=list(mu=matrix(rnorm(length(panel)*max(panel), mean = 0, sd = 1), nrow=length(panel),  ncol=max(panel)), beta=runif(4), alpha0=matrix(c(runif(4), runif(4, 1, 2)), nrow=4, ncol=2, byrow=TRUE)),
         "3"=list(mu=matrix(rnorm(length(panel)*max(panel), mean = 0, sd = 1), nrow=length(panel),  ncol=max(panel)), beta=runif(4), alpha0=matrix(c(runif(4), runif(4, 1, 2)), nrow=4, ncol=2, byrow=TRUE))))
}
#source("draws1.R")
#source("draws2.R")
#source("draws3.R")
