...
MakeInits <- function(){
  ...
  ALPHA03 <- matrix(c(runif(nIRT.Ordered3, 0, 1),
                      runif(nIRT.Ordered3, 1, 2)), nrow=nIRT.Ordered3, ncol=Cuts3, byrow=F)

  BETA5 <- runif(nIRT.Ordered5)
  ALPHA05 <- matrix(c(runif(nIRT.Ordered5, 0.0, 0.5),
                      runif(nIRT.Ordered5, 0.5, 1.0),
                      runif(nIRT.Ordered5, 1.0, 1.5),
                      runif(nIRT.Ordered5, 1.5, 2.0)), nrow=nIRT.Ordered5, ncol=Cuts5, byrow=F)

  BETA6 <- runif(nIRT.Ordered6)
  ALPHA06 <- matrix(c(runif(nIRT.Ordered6, 0.0, 0.5),
                      runif(nIRT.Ordered6, 0.5, 1.0),
                      runif(nIRT.Ordered6, 1.0, 1.5),
                      runif(nIRT.Ordered6, 1.5, 2.0),
                      runif(nIRT.Ordered6, 2.0, 2.5)), nrow=nIRT.Ordered6, ncol=Cuts6, byrow=F)
...
NAME <- "LatentRepressionConstantStandardDynamicX.bug"
...
#write.csv(as.data.frame(mat1), "EstimateConstantStandardDynamicX.csv")
write.csv(as.data.frame(posterior.estimates), "EstimateConstantStandardDynamicX.csv")
...
NAME <- "LatentRepressionConstantStandardDynamicX_YSTAR.bug"
