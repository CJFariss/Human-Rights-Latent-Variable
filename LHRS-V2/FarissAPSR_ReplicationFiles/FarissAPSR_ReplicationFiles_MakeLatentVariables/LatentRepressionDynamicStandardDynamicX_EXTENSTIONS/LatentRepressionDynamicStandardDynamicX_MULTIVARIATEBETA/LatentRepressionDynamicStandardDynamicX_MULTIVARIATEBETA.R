...
NAME <- "LatentRepressionDynamicStandardDynamicX_MULTIVARIATEBETA.bug"
...
write.csv(as.data.frame(posterior.estimates), "EstimateDynamicStandardDynamicX_MULTIVARIATEBETA.csv", row.names=F)
